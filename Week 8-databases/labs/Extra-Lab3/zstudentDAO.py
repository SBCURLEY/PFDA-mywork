...
class StudentDAO:
    ...
    def __init__(self):                             # sets the host, etc. Should come from a configuration file
    ...
    def getCursor(self):                            # making a connection to the database
    ...
    def create(self, student):
        ...
        newid = cursor.lastrowid        # what was the id of the last one created   
        student["id"] = newid
        self.closeAll()
        return student
